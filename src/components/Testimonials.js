...
const Card = ({ star, title, imgSrc }) => {
  return (
    <div className="mx-2 flex flex-col gap-4 select-none cursor-pointer border border-[#4e4e4e31] p-10 rounded-lg hover:shadow-xl transition-all">
      ...
      Adquira experiência de trabalho trabalhando com esta equipe incrível e, no futuro, queira
      trabalhar em conjunto em projetos futuros promissores e também fazer um depósito para
      freelancer.
      </p>
...
const Testimonials = () => {
  return (
    ...
    >
      <div>
        <span className="service-name text-center ">DEPOIMENTO</span>
        <h2 className="title text-center ">Atender à Satisfação do Cliente</h2>
      </div>
      <Carousel {...carouselParams}>
        <div>
          <Card
            star={<StarHalfRoundedIcon />}
            title="Visual moderno e design em alta."
